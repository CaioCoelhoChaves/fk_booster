...
The example project needs to have a backend + database running to work properly.
To run it you can follow the README.md of my the backend-example project: [backend-example](https://github.com/CaioCoelhoChaves/fk-repository-example-backend).
